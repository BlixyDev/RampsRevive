...
Citizen.CreateThread(function()
	...
	drawoppon(1.350, 1.460, 1.2,1.0,0.50, "Playing At ~g~Park Ramps -~w~ (ID: " .. GetPlayerServerId(NetworkGetEntityOwner(GetPlayerPed(-1))) .. ') - ~w~'.. GetPlayerName(PlayerId()), 255, 255, 255, 255)
	end
end
end)
